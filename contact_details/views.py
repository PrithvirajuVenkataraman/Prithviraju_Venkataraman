...
def contact_update(request, pk):
    ...
    return render(request, 'contact_details/contact_update.html', {'form': form})
...
def contact_edit(request, pk):
    ...
    if request.method == 'POST':
        ...
        form = ContactForm(instance=contact)
    return render(request, 'contact_details/contact_edit.html', {'form': form, 'contact': contact})
